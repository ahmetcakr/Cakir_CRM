using CRM.Application.Features.UserOperationClaims.Commands.Create;
using CRM.Application.Features.UserOperationClaims.Commands.Delete;
using CRM.Application.Features.UserOperationClaims.Commands.Update;
using CRM.Application.Features.UserOperationClaims.Queries.GetById;
using CRM.Application.Features.UserOperationClaims.Queries.GetList;
using AutoMapper;
using Core.Application.Responses;
using Core.Persistence.Paging;
using Core.Security.Entities;

namespace CRM.Application.Features.UserOperationClaims.Profiles;
